...
Once we are happy with this process, a future document will build upon this document and will describe how to perform the same trick for multi-tcp-port and multi-domain (eg: CDN-enabled or subdomained) websites, including (some amount of) SSL experimentation. **UPDATE** - this [tool is now implemented](https://github.com/alecmuffett/eotk)
